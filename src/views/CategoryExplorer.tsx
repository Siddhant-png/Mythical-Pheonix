      ...
      <div className="relative w-full max-w-[95%] mx-auto">
        <div className="relative flex items-center">
          ...
          <input
            ...
            placeholder="Search for Products & Services (e.g., Drone, AI, Water, Pharma)..."
            className="w-full pl-9 pr-4 py-2.5 bg-white text-slate-900 placeholder-slate-400 text-xs sm:text-sm font-semibold rounded-xl border border-slate-200/90 shadow-xs focus:outline-none focus:ring-2 focus:ring-[#CAB9E3] focus:border-[#CAB9E3] transition-all"
          />
        </div>
      </div>
