...
export const INITIAL_ALLIANCE_PROPOSALS: AllianceProposal[] = [
  {
    ...
    note: 'Requesting a consortium pairing for the Agriculture challenge.'
  },
  {
    id: 'prop-102',
    senderId: 'mfr-mahainfra-epc',
    senderName: 'MahaInfra System Integrators',
    ...
    note: 'We need your computer-vision algorithms to complete this consortium.'
  }
];
